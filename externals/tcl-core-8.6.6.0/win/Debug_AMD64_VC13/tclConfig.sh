...
TCL_DEFS='-nologo -c -W3 -DUNICODE -D_UNICODE -W3 -D _CRT_SECURE_NO_DEPRECATE -D _CRT_NONSTDC_NO_DEPRECATE -Fp.\Debug_AMD64_VC13\tcl_ThreadedDynamic\ -Zi -Od -wd4456 -wd4457 -wd4458 -wd4459 -wd4996 -MDd -I"E:\dl\Python-3.6.9\Python-3.6.9\externals\tcl-core-8.6.6.0\win\..\win" -I"E:\dl\Python-3.6.9\Python-3.6.9\externals\tcl-core-8.6.6.0\win\..\generic" -I"E:\dl\Python-3.6.9\Python-3.6.9\externals\tcl-core-8.6.6.0\win\..\libtommath" -DTCL_TOMMATH -DMP_PREC=4 -Dinline=__inline -DHAVE_ZLIB=1 -DTCL_CFGVAL_ENCODING=\"cp1252\" -DSTDC_HEADERS -DTCL_THREADS=1 -DUSE_THREAD_ALLOC=1 -DTCL_CFG_DO64BIT'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:\dl\Python-3.6.9\Python-3.6.9\externals\tcltk64\lib\tcl86tg.lib'
